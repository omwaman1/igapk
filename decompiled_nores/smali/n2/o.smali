...
.method public final a()Landroid/graphics/Canvas;
    ...
    .line 1
    iget-object v0, p0, Ln2/o;->a:Landroid/graphics/Canvas;
    ...
    .line 7
    .line 8
    invoke-static {v0}, Lr2/a;->c(Ljava/lang/String;)Ljava/lang/Void;
...
.method public final clipOutPath(Landroid/graphics/Path;)Z
    ...
    .line 1
    invoke-virtual {p0}, Ln2/o;->a()Landroid/graphics/Canvas;
    ...
    .line 5
    invoke-static {v0, p1}, Ln2/c;->a(Landroid/graphics/Canvas;Landroid/graphics/Path;)Z
...
.method public final clipOutRect(FFFF)Z
    ...
    invoke-static {v0, p1, p2, p3, p4}, Ln2/c;->b(Landroid/graphics/Canvas;FFFF)Z
...
.method public final clipOutRect(IIII)Z
    ...
    invoke-static {v0, p1, p2, p3, p4}, Ln2/c;->c(Landroid/graphics/Canvas;IIII)Z
...
.method public final clipOutRect(Landroid/graphics/Rect;)Z
    ...
    invoke-static {v0, p1}, Ln2/c;->d(Landroid/graphics/Canvas;Landroid/graphics/Rect;)Z
...
.method public final clipOutRect(Landroid/graphics/RectF;)Z
    ...
    invoke-static {v0, p1}, Ln2/c;->e(Landroid/graphics/Canvas;Landroid/graphics/RectF;)Z
...
.method public final disableZ()V
    ...
    .line 5
    invoke-static {v0}, Ln2/d;->a(Landroid/graphics/Canvas;)V
...
.method public final drawColor(ILandroid/graphics/BlendMode;)V
    ...
    invoke-static {v0, p1, p2}, Ln2/d;->b(Landroid/graphics/Canvas;ILandroid/graphics/BlendMode;)V
...
.method public final drawColor(J)V
    ...
    invoke-static {v0, p1, p2}, Ln2/d;->c(Landroid/graphics/Canvas;J)V
...
.method public final drawColor(JLandroid/graphics/BlendMode;)V
    ...
    invoke-static {v0, p1, p2, p3}, Ln2/d;->d(Landroid/graphics/Canvas;JLandroid/graphics/BlendMode;)V
...
.method public final drawDoubleRoundRect(Landroid/graphics/RectF;FFLandroid/graphics/RectF;FFLandroid/graphics/Paint;)V
    ...
    .line 2
    invoke-static/range {v0 .. v7}, Ln2/d;->e(Landroid/graphics/Canvas;Landroid/graphics/RectF;FFLandroid/graphics/RectF;FFLandroid/graphics/Paint;)V
...
.method public final drawDoubleRoundRect(Landroid/graphics/RectF;[FLandroid/graphics/RectF;[FLandroid/graphics/Paint;)V
    ...
    invoke-static/range {v0 .. v5}, Ln2/d;->f(Landroid/graphics/Canvas;Landroid/graphics/RectF;[FLandroid/graphics/RectF;[FLandroid/graphics/Paint;)V
...
.method public final drawGlyphs([II[FIILandroid/graphics/fonts/Font;Landroid/graphics/Paint;)V
    ...
    .line 12
    invoke-static/range {v0 .. v7}, Ln2/f;->a(Landroid/graphics/Canvas;[II[FIILandroid/graphics/fonts/Font;Landroid/graphics/Paint;)V
...
.method public final drawPatch(Landroid/graphics/NinePatch;Landroid/graphics/Rect;Landroid/graphics/Paint;)V
    ...
    invoke-static {v0, p1, p2, p3}, Ln2/f;->b(Landroid/graphics/Canvas;Landroid/graphics/NinePatch;Landroid/graphics/Rect;Landroid/graphics/Paint;)V
...
.method public final drawPatch(Landroid/graphics/NinePatch;Landroid/graphics/RectF;Landroid/graphics/Paint;)V
    ...
    invoke-static {v0, p1, p2, p3}, Ln2/f;->c(Landroid/graphics/Canvas;Landroid/graphics/NinePatch;Landroid/graphics/RectF;Landroid/graphics/Paint;)V
...
.method public final drawRenderNode(Landroid/graphics/RenderNode;)V
    ...
    .line 5
    invoke-static {v0, p1}, Ln2/d;->g(Landroid/graphics/Canvas;Landroid/graphics/RenderNode;)V
...
.method public final drawTextRun(Landroid/graphics/text/MeasuredText;IIIIFFZLandroid/graphics/Paint;)V
    ...
    .line 6
    invoke-static/range {v0 .. v9}, Ln2/d;->h(Landroid/graphics/Canvas;Landroid/graphics/text/MeasuredText;IIIIFFZLandroid/graphics/Paint;)V
...
.method public final enableZ()V
    ...
    .line 5
    invoke-static {v0}, Ln2/d;->i(Landroid/graphics/Canvas;)V
...
.method public final quickReject(FFFF)Z
    ...
    invoke-static {v0, p1, p2, p3, p4}, Ln2/e;->a(Landroid/graphics/Canvas;FFFF)Z
...
.method public final quickReject(Landroid/graphics/Path;)Z
    ...
    invoke-static {v0, p1}, Ln2/e;->b(Landroid/graphics/Canvas;Landroid/graphics/Path;)Z
...
.method public final quickReject(Landroid/graphics/RectF;)Z
    ...
    invoke-static {v0, p1}, Ln2/e;->c(Landroid/graphics/Canvas;Landroid/graphics/RectF;)Z
