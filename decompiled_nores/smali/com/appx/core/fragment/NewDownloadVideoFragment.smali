...
.method public encryptFile(Ltn/a;)V
    ...
    .line 32
    # INVERTED: was if-eqz (skip when encryption=="0"), now if-nez (skip when encryption!="0")
    # This means: when encryption!="0" (file is encrypted), apply XOR to DECRYPT it
    # When encryption=="0" (file is plain), skip - leave it as-is
    if-nez v0, :cond_0
    ...
    .line 44
    .line 45
    invoke-static {v1, v0}, Lcom/appx/core/utils/m0;->f(Ljava/lang/String;Ljava/lang/String;)Z
    :try_end_0
    ...
    .line 58
    .line 59
    invoke-virtual {v0, p1, v1}, Lcom/appx/core/viewmodel/NewDownloadViewModel;->setEncryptFile(Ljava/lang/String;Ljava/lang/String;)V
