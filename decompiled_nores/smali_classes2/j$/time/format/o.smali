...
.method public final a(Lj$/time/format/y;J)J
    ...
    .line 2982
    invoke-interface {p1, v2}, Lj$/time/chrono/m;->B(Lj$/time/temporal/n;)Lj$/time/chrono/b;
...
.method public final c(Lj$/time/format/v;JII)I
    ...
    .line 2997
    :cond_0
    invoke-interface {v1, v0}, Lj$/time/chrono/m;->B(Lj$/time/temporal/n;)Lj$/time/chrono/b;

    move-result-object v0

    iget-object v1, p0, Lj$/time/format/i;->a:Lj$/time/temporal/r;

    invoke-interface {v0, v1}, Lj$/time/temporal/n;->k(Lj$/time/temporal/r;)I
