...
.method public constructor <init>(Lj$/time/temporal/n;Lj$/time/format/DateTimeFormatter;)V
    ...
    .line 132
    :cond_0
    sget-object v1, Lj$/time/temporal/s;->b:Lj$/time/g;

    invoke-interface {p1, v1}, Lj$/time/temporal/n;->h(Lj$/time/g;)Ljava/lang/Object;
    ...
    .line 133
    sget-object v2, Lj$/time/temporal/s;->a:Lj$/time/g;

    invoke-interface {p1, v2}, Lj$/time/temporal/n;->h(Lj$/time/g;)Ljava/lang/Object;
    ...
    invoke-interface {p1, v5}, Lj$/time/temporal/n;->e(Lj$/time/temporal/r;)Z
    ...
    .line 164
    invoke-interface {v3, p1}, Lj$/time/chrono/m;->B(Lj$/time/temporal/n;)Lj$/time/chrono/b;
    ...
    invoke-direct {v0, v4, p1, v3, v2}, Lj$/time/format/x;-><init>(Lj$/time/chrono/b;Lj$/time/temporal/n;Lj$/time/chrono/m;Lj$/time/w;)V
...
.method public final a(Lj$/time/temporal/r;)Ljava/lang/Long;
    ...
    invoke-interface {v1, p1}, Lj$/time/temporal/n;->e(Lj$/time/temporal/r;)Z
    ...
    .line 308
    :cond_0
    invoke-interface {v1, p1}, Lj$/time/temporal/n;->E(Lj$/time/temporal/r;)J
