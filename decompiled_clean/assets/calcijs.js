...
$('.keyPad_TextBox1').focus(function(){
 ...
 if(calc==1)
 {
	...
	jQuery('.keyPad_TextBox').css('width','188px');
	jQuery('.keyPad_TextBox1').css('width','188px');
	jQuery('.memoryshow').css('right','182px');
	jQuery('.memoryhide').css('right','182px');
	$('#Pi').css('display','none');
	$('#Ei').css('display','none');
	$('#dr').removeClass('degree_radian');
	 $('.degree_radian').css('display','none'); 
	$('.keyPad_btnConst').css('display','none');
	$('.keyPad_btnConst').css('display','none');
	$('#keyPad_btnMod').css('display','none');
	$('#keyPad_btnFact').css('display','none');
	$('#keyPad_btnSinH').css('display','none');
	$('#keyPad_btnCosinH').css('display','none');
	$('#keyPad_btnTgH').css('display','none');
	$('#keyPad_EXP').css('display','none');
	$('#keyPad_btnOpen').css('display','none');
	$('#keyPad_btnClose').css('display','none');
	$('#keyPad_btnAsinH').css('display','none');
	$('#keyPad_btnAcosH').css('display','none');
	$('#keyPad_btnAtanH').css('display','none');
	$('#keyPad_btnLogBase2').css('display','none');
	$('#keyPad_btnLn').css('display','none');
	$('#keyPad_btnLg').css('display','none');
	$('#keyPad_btnExp').css('display','none');
	$('#keyPad_btnYlogX').css('display','none');	
	$('#keyPad_btn10X').css('display','none');
	$('#keyPad_btnSin').css('display','none');
	$('#keyPad_btnCosin').css('display','none');
	$('#keyPad_btnTg').css('display','none');
	$('#keyPad_btnYpowX').css('display','none');
	$('#keyPad_btnCube').css('display','none');
	$('#keyPad_btnSquare').css('display','none');
	$('#keyPad_btnAsin').css('display','none');
	$('#keyPad_btnAcos').css('display','none');
	$('#keyPad_btnAtan').css('display','none');
	$('#keyPad_btnYrootX').css('display','none');
	$('#keyPad_btnCubeRoot').css('display','none');
	$('#keyPad_btnAbs').css('display','none');
	$('#keyPad_btnEnter').css('right','10px');
	$('#keyPad_btnEnter').css('height','53px');
	$('#keyPad_btn0').attr('style', 'width: 73px !important;');
    $('#keyPad_btnBack').attr('style', 'width: 73px !important;');
...
function divMove(e) {
    ...
    if (e.clientY < height && e.clientY > 0)
        ...
        div.style.top = 30 + 'px';
    console.log(window.innerWidth + " " + window.innerHeight + " " + e.clientX + " " + e.clientY + " " + div.style.top + " " + div.style.left);//1064 116 1342 105
}
